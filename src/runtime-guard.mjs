...
async function hit(url, { fetchFn, timeoutMs, authHeader, vercelBypassToken }) {
  const headers = { 'user-agent': 'MABRIG-DevShield-Runtime-Guard/2.5', 'x-devshield-runtime-probe': '1' };
...
function sarif(r) {
  return { version: '2.1.0', $schema: 'https://json.schemastore.org/sarif-2.1.0.json', runs: [{
    tool: { driver: { name: 'MABRIG DevShield Runtime Guard', version: '2.5.0' } },
...
export async function runRuntimeGuard(options = {}) {
  ...
  const report = {
    schemaVersion: 1, tool: 'MABRIG DevShield Runtime Guard', version: '2.5.0',
